        ...
        const tools = [
          ...
          },
          {
            ...
            inputSchema: {
              type: 'object',
              properties: {
                location: { type: 'string', description: 'Location: full place name or coordinates ("lat, lon"). Chinese "city+sub-area" like "上海三林" is fine as one string (auto-resolved). If a previous call returned a numbered location list, re-call with the chosen coordinates or a more specific name.' }
              },
              required: ['location']
            }
          }
